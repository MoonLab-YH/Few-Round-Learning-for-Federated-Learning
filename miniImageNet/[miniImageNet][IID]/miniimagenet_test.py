...
data_path = '/drive1/Doyeon/data/miniImageNet/'
...
def main():
    ...
    loader_test = Loader_test(data_path=test_path, args = args, max_iter=5000)
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--n_split', type=int, default=5)
    argparser.add_argument('--test_n_split', type=int, default=10)
    ...
    argparser.add_argument('--gpu', type=int, help='gpu number', default=0)
